...
const Card = ({ className, heading, desc }) => {
    ...
    return (
        <motion.div
            ...
            className={`rounded-3xl p-4 bg-slate-500  justify-center items-start flex flex-col hover:bg-white hover:cursor-pointer  ${className}`}
        >
            ...
            <div className="relative ">
                <button
                    onClick={handleClick}
                    className=" text-sm  my-3 rounded-xl hover:bg-yellow-400 p-3"
                >
                    Summarize
                </button>
